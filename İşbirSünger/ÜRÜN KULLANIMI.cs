...
{
    public partial class ÜRÜN_KULLANIMI : Form
    {
        public ÜRÜN_KULLANIMI()
        {
            InitializeComponent();
        }
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            else if (dataGridView1.CurrentCell.ColumnIndex == dataGridView1.ColumnCount - 1)
            {
                ...
                harcanan= Convert.ToDecimal(dataGridView1.Rows[dataGridView1.CurrentCell.RowIndex].Cells[9].Value.ToString());
                dataGridView1.Rows[dataGridView1.CurrentCell.RowIndex].Selected = true;
                kalan = Convert.ToDecimal(dataGridView1.Rows[dataGridView1.CurrentCell.RowIndex].Cells[10].Value.ToString());
        ...
        private void ÜRÜN_KULLANIMI_Load(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("BEKLENMEDİK BİR HATA İLE KARŞILAŞILDI. LÜTFEN UYGULAMAYI TEKRAR BAŞLATIN."+ a.ToString());
            }
            finally
            {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else if(kalan < Convert.ToDecimal(textBox5.Text + "," + textBox6.Text)){
            ...
            else
            {
                try
                {
                    ...
                    SqlCommand komutkaydet = new SqlCommand("insert into  ÜrünHareketleri (Ürün,KullanımMiktarı,Tarih,[Not],ÜrünHareketi) values (@p1, @p2, @p3, @p4,'KULLANIM')", trans);
                    ...
                    SqlCommand komutkaydet2 = new SqlCommand("update  Ürünler set Harcanan=@p1  where ID='"+secilen+"'", trans);
                    ...
                    SqlCommand komutkaydet3 = new SqlCommand("update  GünToplam set Harcanan=@p1,Gün=@p2  where Ürün='" + secilen + "' and Gün='" + dateTimePicker3.Value.Date.ToString("yyyyMMdd") + "'", trans);
