...
{
    public partial class ÜRÜN_SATIŞI : Form
    {
        public ÜRÜN_SATIŞI()
        {
            InitializeComponent();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    SqlCommand komutkaydet = new SqlCommand("insert into  ÜrünHareketleri (Ürün,KullanımMiktarı,Tarih,[Not],ÜrünHareketi) values (@p1, @p2, @p3, @p4,'SATIŞ')", trans);
        ...
        private void ÜRÜN_SATIŞI_Load(object sender, EventArgs e)
        {
