...
{
    public partial class ÜRÜN_SATIŞ_DÜZENLEME : Form
    {
        public ÜRÜN_SATIŞ_DÜZENLEME()
        {
            InitializeComponent();
        }
                ...
                if (result == DialogResult.Yes)
                {
                    ...
                    if (dialogResult == DialogResult.Yes)
                    {
                        try
                        {
                            ...
                            SqlCommand komutkaydet1 = new SqlCommand("update  Ürünler Harcanan=@p1 set where ID='" + ürünid + "'", baglan.baglan());
        ...
        private void ÜRÜN_SATIŞ_DÜZENLEME_Load(object sender, EventArgs e)
        {
